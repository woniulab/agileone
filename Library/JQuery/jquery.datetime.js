...
//strFrame+='          <tr bgcolor="#63A3E9"><td id=bUseTimeLayer width=30  style="cursor:hand" title="点击这里启用/禁用时间"'; //by Qiang
strFrame+='          <tr bgcolor="#63A3E9"><td id=bUseTimeLayer width=30  style="cursor:hand" title="时间"';
strFrame+='				onmouseover="style.backgroundColor=\'#aaccf3\'" align=center onmouseout="style.backgroundColor=\'#63A3E9\'"';
//strFrame+='				 onclick="parent.UseTime(this)">'; //by Qiang
strFrame+= '>';
...
//function setday(tt,showtime) //主调函数
function calendar(tt,showtime)
{
	bUseTime = showtime;
	...
	dads.left = tleft;
	//outObject = (arguments.length == 1) ? th : obj; //by Qiang
	outObject = th;
