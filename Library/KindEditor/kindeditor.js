...
KE.lang = {
	    ...
	    copy : 'Copy',
	    paste : 'Paste',
	    plainpaste : 'Paste Plain Text',
	    wordpaste : 'Paste From Word',
	    selectall : 'Select All',
	    justifyleft : 'Left',
	    justifycenter : 'Center',
	    justifyright : 'Right',
	    justifyfull : 'Align Both',
	    ...
	    layer : 'Insert Layer',
	    table : 'Insert Table',
	    specialchar : 'Insert Special Char',
	    hr : 'Insert Horizontal Line',
	    emoticons : 'Insert Emotion Icon',
	    link : 'Hyperlink',
	    unlink : 'Undo Hyperlink',
	    ...
	    invalidSwf : "Please input a valid URL.\nOnly accept swf format.",
	    invalidImg : "Please input a valid URL.\nOnly accept jpg,jpeg,gif,png,bmp format.",
	    invalidMedia : "Please input a valid URL.\nOnly accept mp3,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb format",
	    invalidWidth : "The Width must be a number.",
	    invalidHeight : "The Height must be a number.",
	    invalidBorder : "The Border must be a number.",
	    invalidUrl : "URL incorrect.",
...
KE.create = function(id, mode) {
    ...
    bottomLeft.style.height = 1;
    bottomLeft.style.padding = 0;
    bottomLeft.style.margin = 0;
    bottomLeft.style.width = "98%";
    var bottomRight = row.insertCell(1);
    bottomRight.className = 'ke-bottom-right';
    bottomRight.style.height = 2;
    bottomRight.style.padding = 0;
    bottomRight.style.margin = 0;
    bottomRight.style.width= "2%";
//    var img = KE.$$('img');
...
KE.init = function(config) {
    ...
    var defaultHtmlTags = {
        ...
        'table' : ['border', 'bgcolor', 'cellspacing', 'cellpadding', 'width', 'height', '.padding', '.margin', '.border'],
        'tbody': [],
        'tr': ['bgcolor'],
        'td': ['align', 'bgcolor', '.text-align', '.color', '.background-color', '.font-size', '.font-family', '.font-weight', '.font-style', '.text-decoration', '.vertical-align'],
        'strong': [],
        'b': [],
...
KE.plugin['media'] = {
    ...
    check : function(id, url) {
        if (!url.match(/^\w+:\/\/.{3,}\.(mp3|wav|wma|wmv|mid|avi|mpg|mpeg|asf|rm|rmvb|swf|flv)(\?|$)/i)) {
...
KE.plugin['table'] = {
    ...
    exec : function(id, value) {
        ...
        var html = '<table border="0" cellpadding="3" cellspacing="1" bgcolor="#333333" width="100%">';
